...
class AITextSearchInsightsPage extends StatefulWidget {
  final String searchQuery;

  const AITextSearchInsightsPage({
    Key? key,
    required this.searchQuery,
  }) : super(key: key);

  @override
  State<AITextSearchInsightsPage> createState() =>
      _AITextSearchInsightsPageState();
}

class _AITextSearchInsightsPageState extends State<AITextSearchInsightsPage> {
